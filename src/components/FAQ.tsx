...
const faqs = [
  { q: '¿Candela es una agencia de marketing?', a: 'No. Nos especializamos en implementación y automatización. No hacemos publicidad ni gestionamos redes sociales. Nos enfocamos en configurar tus canales de venta (marketplaces, tiendas) y automatizar los procesos operativos de tu negocio.' },
  ...
  { q: '¿Ayudan a vender en Amazon, TikTok Shop y Mercado Libre?', a: 'Sí. Trabajamos con todos estos marketplaces. Nos encargamos de abrir la cuenta, configurarla correctamente, cargar tu catálogo de productos y lanzar tus primeras ventas.' },
  { q: '¿También automatizan negocios locales como carnicerías o restaurantes?', a: 'Sí. Tenemos soluciones específicas para negocios locales: formularios de pedido automatizados, notificaciones al cliente y al negocio, organización de pedidos y seguimiento. Todo sin necesidad de una tienda online compleja.' },
  ...
  { q: '¿Cuánto tiempo tarda la implementación?', a: 'Depende del proyecto. Una tienda básica en Shopify puede estar lista en una semana. Una implementación completa en varios marketplaces con automatizaciones puede tomar 3-6 semanas. Lo definimos en el plan de implementación.' },
];
